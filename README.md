...
### BonePositionSynchronizeって何？オンにしていい？  
...
### ShowInformationをオンにしたらAvailableが0
VMCでVRMモデルを読み込んでいないと0になります。

### ShowInformationをオンにしたらTimeが動かない  
VMCと通信できていないときに発生します。  
VMCの詳細設定から「OSCでモーション送信を有効にする」を有効にしてください。  

### BoneRotationFilterEnableって何？オンにしていい？    
オンにすると、簡易的にボーンの回転にローパスフィルタを掛けます。  
手ブレやガクつきをなくしたい場合にオンにしてください。  
**なお、BonePositionSynchronizeがオンの場合は効果が半減します**  
